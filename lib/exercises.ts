...
export const IMAGE_CROPS: Record<string, ImageCrop> = {
  ...
  cable_wood_chop: {
    key: "cable_wood_chop",
    label: "High-to-low cable wood chop",
    x: 866,
    y: 12,
    width: 816,
    height: 906,
...
export const DEFAULT_EXERCISES: ExerciseDefinition[] = [
  ...
  },
  {
    ...
    restSeconds: 90,
    incrementLb: 5,
    imageKey: "captains_chair_knee_raise",
    defaultWeightLb: 0,
  },
  {
    id: "cable_wood_chop",
    workoutType: "legs_abs",
    order: 4,
    name: "High-to-Low Cable Wood Chop (Each Side)",
    minReps: 10,
    maxReps: 15,
    targetSets: 2,
    restSeconds: 90,
    incrementLb: 5,
    imageKey: "cable_wood_chop",
  },
];
